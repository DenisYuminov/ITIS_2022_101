...
class CatalogViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, ProductPresentorDelegate {
    ...
    let presentor = CatalogPresentor(catalogService: MockCatalogService())

    override func viewDidLoad() {
        super.viewDidLoad()
        self.title = "Products"
        self.tableView.restorationIdentifier = "catalogTableView"
        self.tableView.accessibilityIdentifier = "catalogTableView"
